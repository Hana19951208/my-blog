...
export default function EditorPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] pb-20 dark:bg-black">
      {/* Top Bar */}
        ...
        {!preview ? (
          <div className="space-y-6">
            ...
            <input
              ...
              className="w-full border-none bg-transparent text-5xl font-extrabold tracking-tight text-gray-900 placeholder-gray-200 outline-none focus:ring-0 dark:text-white dark:placeholder-zinc-800"
            />
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full border-none bg-transparent p-0 font-mono text-sm text-gray-600 outline-none focus:ring-0 dark:text-gray-400"
          ...
          <div className="prose prose-lg dark:prose-invert mx-auto py-10">
            ...
            <div className="mb-10 text-gray-400">Preview Mode</div>
