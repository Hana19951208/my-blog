                ...
                <form onSubmit={handleAuth} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full rounded-xl border border-gray-200 bg-white/50 px-4 py-2.5 text-sm outline-none ring-offset-2 transition-all focus:border-[#0071e3] focus:ring-2 focus:ring-[#0071e3]/20 dark:border-zinc-800 dark:bg-black/50 dark:text-white"
