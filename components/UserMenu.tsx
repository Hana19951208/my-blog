...
export default function UserMenu() {
    ...
    return (
        <div className="flex items-center gap-2">
            <Link
                href="/editor"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-primary-100 text-primary-600 hover:bg-primary-200 dark:bg-primary-900/30 dark:text-primary-400"
                title="Write Post"
            >
